...
{
    #region MySQL
    public class MySQL_AcessoBancoDados
    {
        // CRIA CONEXAO 
        private MySqlConnection CriarConexao()
        {
            return new MySqlConnection(Settings.Default.StringConexaoLocal_MySql);
            //return new MySqlConnection(Settings.Default.StringConexaoProducao_MySql);
        }
